...
$db['default']['dbprefix'] = $config['db_dbprefix'];
$db['default']['pconnect'] = TRUE;
$db['default']['db_debug'] = TRUE;
$db['default']['cache_on'] = $config['db_cache_on'];
$db['default']['cachedir'] = ROOT . '/' . APPPATH . 'cache/db/';
$db['default']['char_set'] = $config['db_char_set'];
$db['default']['dbcollat'] = $config['db_dbcollat'];
$db['default']['swap_pre'] = '';
