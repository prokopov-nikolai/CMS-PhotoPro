...
INSERT INTO {db_dbprefix}vote VALUES (1, 'Нравится ли Вам этот сайт?', '2012-02-02 10:29:27', '4ee835b19afdc600047933');

INSERT INTO {db_dbprefix}vote_answer VALUES (1, 'Да', 1), (2, 'Средне', 1), (3, 'Нет', 1);

INSERT INTO {db_dbprefix}category VALUES (1, 'novosti-proekta', 'Новости проекта', '', '');

INSERT INTO {db_dbprefix}page VALUES (1, 'pozdravlyaem-nash-sayt-otkrilsya', 'Он работает на <a href="http://www.cms-photopro.com">cms для фотографов "PhotoPro"</a><br/>', 'Поздравляем! Наш сайт открылся!', '', '', '2012-02-02 10:31:22', '2012-02-02 10:36:52', 1, '4ee835b19afdc600047933');
